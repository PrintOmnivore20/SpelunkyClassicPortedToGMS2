...
{
    draw_text(__view_get( e__VW.XView, 0 )+9, __view_get( e__VW.YView, 0 )+100, string_hash_to_newline("LABEL:"));
    draw_text(__view_get( e__VW.XView, 0 )+9, __view_get( e__VW.YView, 0 )+116, string_hash_to_newline(textEdit));
}
else if (status == EDIT_MSG)
{
    draw_text(__view_get( e__VW.XView, 0 )+9, __view_get( e__VW.YView, 0 )+100, string_hash_to_newline("MESSAGE:"));
    draw_text(__view_get( e__VW.XView, 0 )+9, __view_get( e__VW.YView, 0 )+116, string_hash_to_newline(textEdit));
}
...
{
    draw_text(__view_get( e__VW.XView, 0 )+9, __view_get( e__VW.YView, 0 )+116, string_hash_to_newline("MUSIC: " + music));
}
...
else if (status == EXIT or status == NEW)
{
    ...
    n = 320 - strLen;
    n = ceil(n / 2);
    draw_text(__view_get( e__VW.XView, 0 )+n, __view_get( e__VW.YView, 0 )+116, string_hash_to_newline("SAVE LEVEL? (Y/N)"));
    ...
    if not (instance_exists(oEntrance))
    {
        ...
        n = 320 - strLen;
        n = ceil(n / 2);
        draw_text(__view_get( e__VW.XView, 0 )+n, __view_get( e__VW.YView, 0 )+116+m, string_hash_to_newline("WARNING: NO ENTRANCE!"));
        m += 8;
    }
    ...
    if not (instance_exists(oExit))
    {
        ...
        n = 320 - strLen;
        n = ceil(n / 2);
        draw_text(__view_get( e__VW.XView, 0 )+n, __view_get( e__VW.YView, 0 )+116+m, string_hash_to_newline("WARNING: NO EXIT!"));
    }
}
else
{
