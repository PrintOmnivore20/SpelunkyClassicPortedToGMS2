...
else if (drawStatus == 2)
{
    ...
    draw_set_color(c_yellow);
    draw_text(16, 16, string_hash_to_newline("A GAME BY"));
    // draw_set_font(global.myFontSmall);
    draw_set_color(c_white);
    draw_text(64, 32, string_hash_to_newline("DEREK YU"));
}
else if (drawStatus == 3)
{
    draw_set_font(global.myFontSmall);
    draw_set_color(c_yellow);
    draw_text(16, 16, string_hash_to_newline("PLATFORM ENGINE"));
    draw_set_color(c_white);
    draw_text(16, 24, string_hash_to_newline("MARTIN PIECYK"));
    draw_set_color(c_yellow);
    draw_text(16, 40, string_hash_to_newline("SOUND EFFECTS MADE USING"));
    draw_set_color(c_white);
    draw_text(16, 48, string_hash_to_newline("DR PETTER'S SFXR"));
    draw_set_color(c_yellow);
    draw_text(16, 64, string_hash_to_newline("SCREEN SCALING CODE"));
    draw_set_color(c_white);
...
else if (drawStatus == 4)
{
    draw_set_font(global.myFontSmall);
    draw_set_color(c_yellow);
    draw_text(16, 16, string_hash_to_newline("MUSIC BY"));
    draw_set_color(c_white);
...
else if (drawStatus == 5)
{
    draw_set_font(global.myFontSmall);
    draw_set_color(c_yellow);
    draw_text(16, 16, string_hash_to_newline("BETA TESTING BY"));
    draw_set_color(c_white);
    ...
    draw_text(16, 64, string_hash_to_newline("GUERT"));
    ...
    draw_text(128, 32, string_hash_to_newline("KAO"));
    ...
    draw_text(128, 88, string_hash_to_newline("TERRY"));
...
else if (drawStatus == 6)
{
    draw_set_font(global.myFontSmall);
    draw_set_color(c_yellow);
    draw_text(16, 16, string_hash_to_newline("THANKS FOR PLAYING!"));
    // draw_set_font(global.myFontSmall);
    draw_set_color(c_white);
    draw_text(32, 32, string_hash_to_newline("SEE YOU NEXT ADVENTURE!"));
}
